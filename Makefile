...
setup:
	docker network create sedig_front || true
...
shell:
	docker-compose -f docker-compose.yml stop sedig
	docker-compose -f docker-compose.yml run --rm --service-ports sedig bash
